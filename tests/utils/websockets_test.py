...
class TestSendWebsocketMessage:
    ...
    @pytest.mark.asyncio
    async def test_various_content_types(self, mock_websocket, mock_logger):
    ...
    @pytest.mark.asyncio
    async def test_special_characters_in_strings(self, mock_websocket, mock_logger):
    ...
    @pytest.mark.asyncio
    async def test_message_structure(self, mock_websocket, mock_logger):
    ...
    @pytest.mark.asyncio
    async def test_empty_strings(self, mock_websocket, mock_logger):
    ...
    @pytest.mark.asyncio
    async def test_large_content(self, mock_websocket, mock_logger):
